...
class CurrencyDisplayWidget extends StatelessWidget {
  ...
  String _getFormattedAmount() {
    ...
    if (isCompact && _shouldUseCompactFormat()) {
      ...
      if (useMinimalFormatting) {
        formattedAmount = SplitEaseCurrencyUtils.formatAmountMinimal(displayAmount, currency);
      } else {
        formattedAmount = SplitEaseCurrencyUtils.formatAmount(displayAmount, currency, decimalPlaces: decimalPlaces);
      }
    }
  ...
  String _formatCompactAmount(double amount) {
    ...
    if (absAmount >= 1000000) {
      ...
      compactAmount = SplitEaseCurrencyUtils.formatAmount(absAmount, currency, decimalPlaces: decimalPlaces);
