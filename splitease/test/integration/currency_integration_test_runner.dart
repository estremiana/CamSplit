  ...
  group('Currency Integration Test Suite', () {
    ...
    group('Currency Integration Test Summary', () {
      ...
      test('should verify currency service initialization', () async {
        ...
        final defaultCurrency = SplitEaseCurrencyService.getDefaultCurrency();
      ...
      test('should verify currency validation works', () {
        ...
        final validResult = SplitEaseCurrencyService.getCurrencyByCode('USD');
        expect(validResult.code, equals('USD'));
        
        // Test fallback for invalid currency
        final fallbackResult = SplitEaseCurrencyService.getCurrencyByCode('INVALID');
      ...
      test('should verify currency cascading logic', () async {
        ...
        await SplitEaseCurrencyService.setGroupCurrency(groupId, usdCurrency);
        final groupCurrency = SplitEaseCurrencyService.getGroupCurrency(groupId);
      ...
      test('should verify locale-based currency detection', () {
        ...
        final detectedCurrency = SplitEaseCurrencyService.getSuggestedCurrencyForLocale('en_US');
        expect(detectedCurrency.code, equals('USD'));
        
        final detectedCurrency2 = SplitEaseCurrencyService.getSuggestedCurrencyForLocale('de_DE');
