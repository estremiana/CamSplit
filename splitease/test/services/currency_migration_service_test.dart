  ...
  group('CurrencyMigrationService', () {
    ...
    group('validateCurrencyData', () {
      ...
      test('should validate valid Currency object', () {
        final currency = SplitEaseCurrencyService.getCurrencyByCode('EUR');
    ...
    group('migrateCurrencyData', () {
      ...
      test('should return Currency object as-is', () {
        final originalCurrency = SplitEaseCurrencyService.getCurrencyByCode('GBP');
    ...
    group('prepareForBackend', () {
      ...
      test('should throw error for unsupported format', () {
        final currency = SplitEaseCurrencyService.getCurrencyByCode('GBP');
    ...
    group('getMigrationStatistics', () {
      test('should calculate statistics for mixed dataset', () {
        final dataset = [
          ...
          SplitEaseCurrencyService.getCurrencyByCode('EUR'), // Currency object - no migration
