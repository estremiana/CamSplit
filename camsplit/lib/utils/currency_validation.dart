...
class CurrencyValidation {
  ...
  static ValidationResult validateCurrency(Currency currency) {
    ...
    } else if (!CamSplitCurrencyService.isValidCurrencyCode(currency.code)) {
  ...
  static ValidationResult validateCurrencyCode(String? code) {
    ...
    if (!CamSplitCurrencyService.isValidCurrencyCode(normalizedCode)) {
  ...
  static Currency getFallbackCurrency(String? invalidCode) {
    if (invalidCode != null && invalidCode.isNotEmpty) {
      ...
      for (final suggestion in suggestions) {
        if (CamSplitCurrencyService.isValidCurrencyCode(suggestion)) {
          return CamSplitCurrencyService.getCurrencyByCode(suggestion);
        }
      }
    }
    
    return CamSplitCurrencyService.getDefaultCurrency();
  }
