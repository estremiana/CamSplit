...
class AppTheme {
  ...
  static const Color successLight =
      Color(0xFF059669); // Clear positive indicators
  static const Color warningLight =
      Color(0xFFD97706); // Attention-drawing amber
  static const Color errorLight = Color(0xFFDC2626); // Unmistakable red
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Bottom navigation with status-aware design
    ...
    // Input decoration with smart assistance
    ...
    // SnackBar theme with collaborative feedback
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles - Inter Medium for professional presentation
