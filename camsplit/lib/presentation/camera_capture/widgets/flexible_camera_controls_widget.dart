...
class FlexibleCameraControlsWidget extends StatelessWidget {
  ...
  const FlexibleCameraControlsWidget({
    super.key,
    ...
    return RepaintBoundary(
      child: Container(
        ...
        child: Row(
          ...
          children: [
            // Gallery Button (if enabled)
            if (config.enableGallery) _buildGalleryButton(),

            // Capture Button
            _buildCaptureButton(),

            // Right Button (Flash or Camera Switch)
            _buildRightButton(),
          ],
        ),
      ),
  ...
  Widget _buildRightButton() {
    if (config.enableCameraSwitch && canSwitchCamera && onSwitchCamera != null) {
    ...
    } else if (config.enableFlash && hasFlash) {
